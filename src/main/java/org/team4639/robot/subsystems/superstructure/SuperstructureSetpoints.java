...
public class SuperstructureSetpoints {
  ...
  public static final SuperstructureState HP =
      new SuperstructureState(
          ...
          Rotation2d.fromDegrees(
              30 - 230 * 0.238), // Wrist_HP_Proportion: 30 - 230 * 0.238 = -24.74 degrees
  ...
  public static final SuperstructureState L1 =
      new SuperstructureState(
          ...
          Rotation2d.fromDegrees(
              30 - 230 * 1.0), // Wrist_L1_Proportion: 30 - 230 * 1.0 = -200.0 degrees
  ...
  public static final SuperstructureState L2 =
      new SuperstructureState(
          ...
          Rotation2d.fromDegrees(
              30 - 230 * 0.95), // Wrist_L2_Proportion: 30 - 230 * 0.95 = -188.5 degrees
  ...
  public static final SuperstructureState L3 =
      new SuperstructureState(
          ...
          Rotation2d.fromDegrees(
              30 - 230 * 0.95), // Wrist_L3_Proportion: 30 - 230 * 0.95 = -188.5 degrees
  ...
  public static final SuperstructureState L4 =
      new SuperstructureState(
          ...
          Rotation2d.fromDegrees(
              30 - 230 * 1.0), // Wrist_L4_Proportion: 30 - 230 * 1.0 = -200.0 degrees
  ...
  public static final SuperstructureState L2_ALGAE =
      new SuperstructureState(
          ...
          Rotation2d.fromDegrees(
              30 - 230 * 0.82), // Wrist_L2_ALGAE_Proportion: 30 - 230 * 0.82 = -158.6 degrees
  ...
  public static final SuperstructureState L3_ALGAE =
      new SuperstructureState(
          ...
          // this equals ~0.8
          Rotation2d.fromDegrees(
              30 - 230 * 0.763), // Wrist_L3_ALGAE_Proportion: 30 - 230 * 0.763 = -145.49 degrees
  ...
  public static final SuperstructureState BARGE =
      new SuperstructureState(
          ...
          Rotation2d.fromDegrees(
              30 - 230 * 0.563), // Wrist_Barge_Proportion: 30 - 230 * 0.563 = -99.49 degrees
  ...
  public static final SuperstructureState GROUND_INTAKE =
      new SuperstructureState(
          ...
          Rotation2d.fromDegrees(
              30 - 230 * 0.845), // Wrist_Ground_Intake_Proportion: 30 - 230 * 0.845 = -164.35
          // degrees
  ...
  public static final SuperstructureState HOMING =
      new SuperstructureState(
          ...
          Rotation2d.fromDegrees(
              30 - 230 * 0.414), // Using IDLE wrist proportion: 30 - 230 * 0.414 = -65.22 degrees
          RotationsPerSecond.of(0.0 * 20) // No intake speed specified, assuming 0.0 RPS
          );
  ...
  public static final SuperstructureState HP_LOWER =
      new SuperstructureState(
          ...
          Rotation2d.fromDegrees(
              30 - 230 * 0.14), // Wrist_HP_Lower_Proportion: 30 - 230 * 0.14 = -2.2 degrees
          RotationsPerSecond.of(0.5 * 20) // Intake_HP_Speed: 0.5 * 20 = 10.0 RPS
          );
