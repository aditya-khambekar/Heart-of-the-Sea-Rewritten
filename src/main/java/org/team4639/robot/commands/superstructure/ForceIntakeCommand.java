...
public class ForceIntakeCommand extends SuperstructureCommandBase {
  private static final Debouncer hasCoralDebouncer =
      new Debouncer(WristConstants.HAS_CORAL_DEBOUNCE_SECONDS, Debouncer.DebounceType.kRising);
  ...
  public void execute() {
    ...
    Subsystems.roller.setVelocity(SuperstructureSetpoints.HP_LOWER.getWheelSpeed());
  }
