...
public class TunerConstants {
  ...
  private static final Current kSlipCurrent = Amps.of(120.0); // @aditya-khambekar we need to fix this
      ...
      new TalonFXConfiguration()
          .withCurrentLimits(
              new CurrentLimitsConfigs()
                  ...
                  .withStatorCurrentLimit(Amps.of(60))// @aditya-khambekar I doubt it needs to be this high
