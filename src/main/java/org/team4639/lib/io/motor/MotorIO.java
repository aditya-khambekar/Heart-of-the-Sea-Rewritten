package org.team4639.lib.io.motor;
...
public abstract class MotorIO implements Sendable {
  ...
  /**
   * Sets the motor to run at at given voltage. Should not be called directly, only applied through
   * Setpoints.
   *
  ...
  /**
   * Sets the motor to use motion magic control to go to a given position. Should not be called
   * directly, only applied through Setpoints.
   *
  ...
  /**
   * Sets the motor to run at a percentage of it's max voltage. Should not be called directly, only
  ...
  /**
   * Sets the motor to use PID control to go to a given position. Should not be called directly,
  ...
  /**
   * Enables this MotorIO. Immediatly applies the last set Setpoint including Setpoints set when
  ...
  /**
   * Disabled this MotorIO. Setpoints can still be set when disabled but will not be applied until
   * re-enabled.
   */
  ...
  public class MotorIOInputs implements Sendable {
    ...
    public void initSendable(SendableBuilder builder) {
      builder.addDoubleProperty(
          ...
          null);
      builder.addDoubleProperty(
          "Position " + unitType.name() + ":", () -> position.in(unitType), null);
      ...
      builder.addDoubleProperty(
          "Motor Temperature Celsius:", () -> motorTemperature.in(Units.Celsius), null);
    }
  }
  ...
  public enum Mode {
    ...
    /**
     * Gets whether the control mode is based on position. Motion Magic and Position PID control
     * count as position.
     *
    ...
    /**
     * Gets whether the control mode is based on voltage. Voltage and Duty Cycle control count as
     * voltage.
     *
