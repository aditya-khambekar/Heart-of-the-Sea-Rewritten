...
package org.team4639.lib.io.swerve;

import static org.team4639.robot.util.PhoenixUtil.*;
...
import org.team4639.robot.subsystems.drive.PhoenixOdometryThread;
import org.team4639.robot.subsystems.drive.generated.TunerConstants;

/**
 * Module IO implementation for Talon FX drive motor controller, Talon FX turn motor controller, and
 * CANcoder. Configured using a set of module org.team4639.frobot.constants from Phoenix.
 *
...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    SmartDashboard.putNumber(
        "Modules/" + this + " Current Draw", driveTalon.getStatorCurrent().getValueAsDouble());
  }
