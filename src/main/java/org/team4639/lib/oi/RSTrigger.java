...
public class RSTrigger extends Trigger {
  ...
  public RSTrigger and(BooleanSupplier trigger) {
    return andCache.computeIfAbsent(
        trigger, t -> new RSTrigger(() -> super.getAsBoolean() && t.getAsBoolean()));
  }

  @Override
  public RSTrigger or(BooleanSupplier trigger) {
    return orCache.computeIfAbsent(
        trigger, t -> new RSTrigger(() -> super.getAsBoolean() || t.getAsBoolean()));
  }
  ...
  public RSTrigger negate() {
    return negated =
        Objects.requireNonNullElseGet(negated, () -> new RSTrigger(() -> !super.getAsBoolean()));
  }
}
